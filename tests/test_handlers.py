...
logging.basicConfig(filename='logs/test_handlers.log', level=logging.DEBUG, filemode='w', format="%(name)s:%(message)s")
...
def test_lock_identifier():
    ...
    filename = 'logs/test_handlers/test_lock_identifier.log'
...
def test_file_usage():
    ...
    filename = 'logs/test_handlers/test_file_usage.log'
...
def test_multiprocess_file():
    ...
    filename = 'logs/test_handlers/test_multiprocess_file.log'
    test_l = 200
    ...
    def worker(n, file):
        ...
        logging.debug(f"Making MPFileHandler {n} - {file}")
...
def test_multiprocess_stream(capfd):
    ...
    filename = 'logs/test_handlers/test_multiprocess_stream.log'
    test_l = 200
